...
function AppContent() {
  ...
  const showMainLayout = splashComplete && initialLoadComplete;

  const handleLoadingComplete = () => {
    setSplashComplete(true);
  };

  // ensure app lands on dashboard after data + splash complete
  useEffect(() => {
    if (showMainLayout && location.pathname === '/') {
      navigate('/dashboard', { replace: true });
    }
  }, [showMainLayout, location.pathname, navigate]);
